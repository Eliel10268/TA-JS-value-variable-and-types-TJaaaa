...
if (age > 55) console.log("You are too old to participate in the marthon");
...
//Initializing result with string "h"
let result = "h";

// Adding "e" to the result string n times
for (let i = 0; i < n; i++) {
  result += "e";
}

// Adding "llo" to the rest of the string
result += "llo";

//Displaying the full word in alert
alert(result);
...
console.log("The Total2 is : ", total);
/* Switch Statement
...
let num0ne = parseInt(prompt("Enter 2 Integers numbers: "));
let numTwo = parseInt(prompt("Enter 2 Integers numbers: "));

if (num0ne > numTwo) {
  alert(`This : ${num0ne} is greater than ${numTwo}`);
} else {
  alert(`This : ${numTwo} is greater than ${num0ne}`);
}
...
if (operation === "Add") {
  ...
  if (number1 >= number2) alert(" Result: " + (number1 - number2));
  else {
